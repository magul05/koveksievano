        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                <a href="<?= base_url('pelanggan/katalog') ?>" class="text-decoration-none d-block d-lg-none">
                    <h1> class="m-0 display-5 font-weight-semi-bold"><span> class="text-primary font-weight-bold border px-3 mr-1">EVANO</span>KONVECTION</h1>
                </a>
            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" style="height: 410px;">
                        <img class="img-fluid" src="<?= base_url('asset/eshopper/') ?>img/slider.jpeg" alt="Image">
