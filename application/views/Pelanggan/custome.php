<!-- Page Header Start -->
<img style="height: 400px ; width:1340px ;" src="<?= base_url('asset/evano.jpeg') ?>" class="container-fluid bg-secondary mb-5">
	...
	<div class="row px-xl-5">
		...
		<div class="col-lg-5 mb-5">
			...
			<div class="d-flex flex-column mb-3">
				...
				<p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Karanganyar, Jawa Tengah</p>
				<p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>evanokon987@gmail.com</p>
...
<script>
	$(document).ready(function() {
		$.ajax({
			type: "POST",
			url: "http://localhost/baju/pelanggan/ongkir/provinsi",
		...
		$("select[name=provinsi]").on("change", function() {
			...
			$.ajax({
				type: "POST",
				url: "http://localhost/baju/pelanggan/ongkir/kota",
		...
		$("select[name=kota]").on("change", function() {
			$.ajax({
				type: "POST",
				url: "http://localhost/baju/pelanggan/ongkir/expedisi",
		...
		$("select[name=expedisi]").on("change", function() {
			...
			$.ajax({
				type: "POST",
				url: "http://localhost/baju/pelanggan/ongkir/paket",
